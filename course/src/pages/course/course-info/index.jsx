  ...
  <RouteContext.Consumer>
    {({ isMobile }) => (
      <Descriptions className={styles.headerList} size="small" column={isMobile ? 1 : 2}>
        <Descriptions.Item label="课程学分"></Descriptions.Item>
        <Descriptions.Item label="课程学时"></Descriptions.Item>
        <Descriptions.Item label="课程开始时间"></Descriptions.Item>
        <Descriptions.Item label="课程类型"></Descriptions.Item>
        <Descriptions.Item label="课程结束时间"></Descriptions.Item>
        <Descriptions.Item label="课程描述"></Descriptions.Item>
      </Descriptions>
    )}
  </RouteContext.Consumer>
);
